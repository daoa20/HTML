...
<body>
	...
	<%
		...
		rs1.open "select * from Artists", conn1
		a = "<table id=songs><tr><th>ID<th>name<th>nationality<th>age<th>description<th>action</tr>"
	%>
	...
	<section class="page-section">
		<div class="container">
				<div class="col-xl-10">
					...
					<a href="adda.html" class="site-btn">Add Artist</a>
					<a href="modifya.html" class="site-btn">Modify Artist</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("artid") & "<td>" & rs1("artname") & "<td>" & rs1("nationality") & "<td>" & rs1("age")& "<td>" & rs1("description") & "<td><a href='deletea.asp?artist=" & rs1("artid") & "' class='site-btn'>Delete Artist</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
