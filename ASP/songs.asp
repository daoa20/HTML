...
<body>
	...
	<%
		...
		rs1.open "select * from Songs", conn1
		a = "<table id=songs><tr><th>ID<th>name<th>description<th>albumid<th>Action</tr>"
	%>
	...
	<section class="page-section">
		<div class="container">
				<div class="col-xl-10">
					...
					<a href="adds.html" class="site-btn">Add Song</a>
					<a href="modify.html" class="site-btn">Modify Song</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("id") & "<td>" & rs1("name") & "<td>" & rs1("description") & "<td>" & rs1("albumid") & "<td><a href='deletes.asp?song=" & rs1("id") & "' class='site-btn'>Delete Song</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
