...
<body>
	...
	<%
		...
		rs1.open "select * from Bands", conn1
		a = "<table id=songs border = 1><tr><th>ID<th>name<th>genreid<th>action</tr>"
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-10">
					...
					<a href="addb.html" class="site-btn">Add Band</a>
					<a href="modifyb.html" class="site-btn">Modify Band</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("bid") & "<td>" & rs1("bname") & "<td>" & rs1("genreid") & "<td><a href='deleteb.asp?b=" & rs1("bid") & "' class='site-btn'>Delete Band</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
