...
<body>
	...
	<%
		...
		rs1.open "select * from AlbumArtistQ where albumid = " + album + " ", conn1
		...
		<div class="container text-center">
			<div class="row">
				<div class="col-xl-10 offset-xl-1">
					<h2 class="section-title"><% response.write a %><span> - </span><% response.write b %></h2>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<div class="row mt-5">
						<div class="col-md-4">
							<div class="milestone">
								<h2><% response.write e %><span>Length</span></h2>
							</div>
						</div>
						<div class="col-md-4"></div>
						<div class="col-md-4">
							<div class="milestone">
								<h2><% response.write c %><span>Released</span></h2>
							</div>
						</div>
					</div>
					<figure class="mt-5">
