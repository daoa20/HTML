...
<body>
	...
	<%
		...
		rs1.open "select * from Playlist", conn1
		a = "<table id=songs border = 1><tr><th>ID<th>songid<th>action</tr>"
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-10">
					...
					<a href="addp.html" class="site-btn">Add Song to a Playlist</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("playid") & "<td>" & rs1("songid") & "<td><a href='deletep.asp?playid=" & rs1("playid") & "' class='site-btn'>Delete Song</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
