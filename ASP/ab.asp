...
<body>
	...
	<%
		...
		rs1.open "select * from ArtistBand", conn1
		a = "<table id=songs border = 1><tr><th>ID<th>artistid<th>bandid<th>action</tr>"
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-10">
					...
					<a href="addab.html" class="site-btn">Add Record</a>
					<a href="modifyab.html" class="site-btn">Modify Record</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("id") & "<td>" & rs1("artistid") & "<td>" & rs1("bandid") & "<td><a href='deleteab.asp?ab=" & rs1("id") & "' class='site-btn'>Delete Record</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
