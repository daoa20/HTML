...
<body>
	...
	<%
		...
		rs1.open "select * from Playlists", conn1
		a = "<table id=songs border = 1><tr><th>ID<th>name<th>description<th>pic<th>action</tr>"
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-10">
					...
					<a href="addps.html" class="site-btn">Add Playlist</a>
					<a href="modifyps.html" class="site-btn">Modify Playlist</a>
					<a href="p.asp" class="site-btn">See Playlist</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("pid") & "<td>" & rs1("pname") & "<td>" & rs1("pdesc") & "<td>" & rs1("pic") & "<td><a href='deleteps.asp?pid=" & rs1("pid") & "' class='site-btn'>Delete Playlist</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
