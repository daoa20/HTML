...
<body>
	...
	<%
		...
		rs1.open "select * from Users", conn1
		a = "<table id=songs border = 1><tr><th>ID<th>username<th>password<th>pic<th>action</tr>"
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-10">
					...
					<a href="addu.html" class="site-btn">Add User</a>
					<a href="modifyu.html" class="site-btn">Modify User</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("id") & "<td>" & rs1("username") & "<td>" & rs1("password") & "<td>" & rs1("pic") & "<td><a href='deleteu.asp?id=" & rs1("id") & "' class='site-btn'>Delete User</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
