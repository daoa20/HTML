...
<body>
	...
	<%
		...
		rs1.open "select * from Genres", conn1
		a = "<table id=songs border = 1><tr><th>ID<th>name<th>action</tr>"
	%>
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-10">
					...
					<a href="addg.html" class="site-btn">Add Genre</a>
					<a href="modifyg.html" class="site-btn">Modify Genre</a>
					<br>
					<br>
					...
					<%
						...
						rs1.movefirst
						while not rs1.eof
						a = "<tr><td>" & rs1("id") & "<td>" & rs1("name") & "<td><a href='deleteg.asp?id=" & rs1("id") & "' class='site-btn'>Delete Genre</a>" & "</tr>"
						response.write a
						rs1.movenext
						wend
